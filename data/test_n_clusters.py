...
if __name__=="__main__":
    ...
    f1,ax1 = plt.subplots(1,1,figsize=(9, 6))
    bins = np.linspace(0,4000,num=100)
    h,_,_,img = ax1.hist2d(tot_n_cell_4,tot_n_cl,bins=[bins,bins],cmap=plt.cm.Blues_r)
    plt.colorbar(img)
    ax1.plot([min(bins),max(bins)],[min(bins),max(bins)],alpha=0.7,color='red')
    ax1.set(ylabel='Number of topoclusters',xlabel='Number of cells |signif| > 4')
    f1.savefig(f'../plots/inputs/n_cl_4sigma_2d.png',dpi=400,bbox_inches="tight")
    plt.close()

    f1,ax1 = plt.subplots(1,1,figsize=(9, 6))
    bins = np.linspace(0,4000,num=100)
    h,_,_,img = ax1.hist2d(tot_n_cell_5,tot_n_cl,bins=[bins,bins],cmap=plt.cm.Blues_r)
    plt.colorbar(img)
    ax1.plot([min(bins),max(bins)],[min(bins),max(bins)],alpha=0.7,color='red')
    ax1.set(ylabel='Number of topoclusters',xlabel='Number of cells |signif| > 5')
    f1.savefig(f'../plots/inputs/n_cl_5sigma_2d.png',dpi=400,bbox_inches="tight")
    plt.close()

    f1,ax1 = plt.subplots(1,1,figsize=(9, 6))
    bins = np.linspace(0,4000,num=100)
    h,_,_,img = ax1.hist2d(tot_n_cell_6,tot_n_cl,bins=[bins,bins],cmap=plt.cm.Blues_r)
    plt.colorbar(img)
    ax1.plot([min(bins),max(bins)],[min(bins),max(bins)],alpha=0.7,color='red')
    ax1.set(ylabel='Number of topoclusters',xlabel='Number of cells |signif| > 6')
    f1.savefig(f'../plots/inputs/n_cl_6sigma_2d.png',dpi=400,bbox_inches="tight")
    plt.close()

    f1,ax1 = plt.subplots(1,1,figsize=(9, 6))
    bins = np.linspace(0,4000,num=100)
    h,_,_,img = ax1.hist2d(tot_n_cell_8,tot_n_cl,bins=[bins,bins],cmap=plt.cm.Blues_r)
    plt.colorbar(img)
    ax1.plot([min(bins),max(bins)],[min(bins),max(bins)],alpha=0.7,color='red')
    ax1.set(ylabel='Number of topoclusters',xlabel='Number of cells |signif| > 8')
    f1.savefig(f'../plots/inputs/n_cl_8sigma_2d.png',dpi=400,bbox_inches="tight")
    plt.close()

    f1,ax1 = plt.subplots(1,1,figsize=(9, 6))
    bins = np.linspace(0,4000,num=100)
    h,_,_,img = ax1.hist2d(tot_n_cell_10,tot_n_cl,bins=[bins,bins],cmap=plt.cm.Blues_r)
    plt.colorbar(img)
    ax1.plot([min(bins),max(bins)],[min(bins),max(bins)],alpha=0.7,color='red')
    ax1.set(ylabel='Number of topoclusters',xlabel='Number of cells |signif| > 10')
    f1.savefig(f'../plots/inputs/n_cl_10sigma_2d.png',dpi=400,bbox_inches="tight")
    plt.close()
